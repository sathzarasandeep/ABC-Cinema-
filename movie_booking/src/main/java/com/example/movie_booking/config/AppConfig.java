...
public class AppConfig {
    ...
    // Security ID for secure access or encryption
    public static final String SECURITY_ID = "ENnGlkrpe1_MuBDr6O-fSYmrij1RQS3qOBttYEdmpI9fcgPhTNuG-1eQ6mqO3TMX7XFr3zWSZAO01WF2";
